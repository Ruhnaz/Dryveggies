...
<div style="width: 48%; float: left; background: white; padding: 15px; border-radius: 10px; box-shadow: 0 4px 15px rgba(0,0,0,0.1); margin-right: 2%;">
...
<div style="width: 48%; float: left; background: white; padding: 15px; border-radius: 10px; box-shadow: 0 4px 15px rgba(0,0,0,0.1); margin-left: 2%;">
