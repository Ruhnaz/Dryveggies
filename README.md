...
<table width="100%" border="0" cellspacing="0" cellpadding="20" style="background: #f8f9fa; border-radius: 10px;">
  <tr>
    ...
    <td width="50%" valign="top" style="padding: 15px;">
      <div style="background: white; padding: 15px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
        <img src="screenshots/single-product-page.png" width="100%" style="border-radius: 6px;">
        <p align="center" style="margin-top: 10px; margin-bottom: 0;"><strong>Single Product Page</strong></p>
      </div>
    </td>
  </tr>
</table>
